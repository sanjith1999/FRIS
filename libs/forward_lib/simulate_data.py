...
class MnistSimulator:
    ...
    def __str__(self):
        ...
        desc += f"Up-sampling Factor\t\t: {self.up_factor}\n"
        return desc
    ...
    def update_data(self):
        ...
        for i in range(self.n_bodies):
            try:
                ux, uy, uz = int(self.mx * self.up_factor[1]), int(self.my * self.up_factor[2]), int(self.mz * self.up_factor[0])
            except:
    ...
    def load_mnist_data(self):
        ...
        self.mnist_limit = len(self.mnist_trainset)-1
