...
class LinearizedModel:
    ...
    Note: before finding transformation manually init_model ~ PSF, init_D2NN pattern ~ creating patterns
    """
    ...
    def find_transformation(self):
        ...
        for i_p in range(self.n_patterns):
            ...
            self.PM.propagate_D2NN(p_no=i_p + 1)
    ...
    def save_matrix(self, it=100, is_original=True):
        ...
        data_to_save = {"NA": PhysicalModel.NA, "voxel_size": [self.dx, self.dy, self.dz], "dimensions": [self.nx, self.ny, self.nz],
    ...
    def log_matrix(self, it=100, is_original=False):
        ...
        data_to_save = {
            ...
            "n_patterns": self.n_patterns, "n_planes": self.n_planes,
